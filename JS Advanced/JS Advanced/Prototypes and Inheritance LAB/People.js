function solution() {
    ...
    class Employee {
        ...
        // Принтира текущата задача на позоция 0 в масива. След това я шифта и я слага най-отзад на масива
        work() {
        ...
        collectSalary() {
            // Ако инстанцията има пропърти dividend тогава значи е мениджър и добавяме бонус към заплатата
